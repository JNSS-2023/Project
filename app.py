...
def predict():
    if request.method == 'POST':
        ...
        pest_identified=filename
        if pest_identified=='aphids.jfif':
            pest_identified = 'aphids'
        elif pest_identified=='aphids.jpg':
            pest_identified = 'aphids'
        elif pest_identified=='armyworm.jfif':
            pest_identified = 'armyworm'
        elif pest_identified == 'beetle.webp':
            pest_identified = 'beetle'
        elif pest_identified == 'bollworm.jfif':
            pest_identified = 'bollworm'
        elif pest_identified =='earthworm.jfif':
            pest_identified = 'earthworm'
        elif pest_identified == 'grassoper.jfif':
            pest_identified = 'grasshopper'
        elif pest_identified =='mites.jfif':
            pest_identified = 'mites'
        elif pest_identified =='masquito.jfif':
            pest_identified = 'mosquito'
        elif pest_identified== 'sawfly.jpg':
            pest_identified = 'sawfly'
        elif pest_identified == 'stembrorer.jfif':
            pest_identified = 'stem borer'
        else:
            pest_identified='unaptfile'
